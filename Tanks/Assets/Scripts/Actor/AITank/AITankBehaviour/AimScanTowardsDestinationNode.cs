...
{
    public class AimScanTowardsDestinationNode : Node
    {
        ...
        public AimScanTowardsDestinationNode(AITankController tankController, float scanAngle, float scanSpeed)
        {
        ...
        public override NodeState Tick()
        {
            ...
            var scanDir = Vector3.Lerp(
                _rotation1 * _tankController.GetDirectionToDestination(),
                _rotation2 * _tankController.GetDirectionToDestination(),
